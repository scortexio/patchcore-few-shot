...
from anomalib.utils.general import get_augmentation_combinations_from_transformer
...
def train(raw_args=None):
    ...
    for augmentation_combination in augmentation_combinations:
        ...
        if args.augment:
            augmentation_transforms = transformer.get_transforms_with_index(list_index=augmentation_combination)
