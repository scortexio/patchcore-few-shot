...
class Patchcore(AnomalyModule):
    ...
    def __init__(
        ...
        self.apply_coreset = apply_coreset
    ...
    def on_validation_start(self) -> None:
        ...
        # optionally apply coreset sampling, depending on the ratio
        if self.apply_coreset:
            logger.info("Applying core-set subsampling to get the embedding.")
            self.model.subsample_embedding(embeddings, self.coreset_sampling_ratio)
        else:
            logger.info("Core-set sampling deactivated, memory bank are equal to the embeddings")
            self.model.memory_bank = embeddings.detach().clone()
...
class PatchcoreLightning(Patchcore):
    ...
    def __init__(self, hparams) -> None:
        super().__init__(
            ...
            apply_coreset=hparams.model.coreset.apply,
            coreset_sampling_ratio=hparams.model.coreset.coreset_sampling_ratio,
